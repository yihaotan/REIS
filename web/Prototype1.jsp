...
<body>
    ...
    $(document).ready(function() {
        $('#right-menu').sidr({
          ...
          onOpen:function(){document.getElementById('map').style.width =  600 + 'px'},
          onClose:function(){document.getElementById('map').style.width =  1100 + 'px';map.setView([1.3667,103.8], 11)}
        });
    });
    var opened=false;
        $(document).ready(function() {
        $('#left-menu').sidr({
          ...
          onOpen:function(){opened=true;document.getElementById('map').style.width =  800 + 'px';document.getElementById('map').style.cssFloat="left"},
          onClose:function(){opened=false;document.getElementById('map').style.width =  1100 + 'px';document.getElementById('map').style.cssFloat="right";map.setView([1.3667,103.8], 11)}
